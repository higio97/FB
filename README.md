...
## 🛡 Installation
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/higio97/File-Sharing-Bot)</br>
...
### Deploy in your VPS
````bash
git clone https://github.com/higio97/File-Sharing-Bot
cd File-Sharing-Man
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/higio97/File-Sharing-Bot/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/higio97/File-Sharing-Bot/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
[FILE-SHARING-BOT](https://github.com/higio97/File-Sharing-Bot/) is Free Software: You can use, study share and improve it at your
